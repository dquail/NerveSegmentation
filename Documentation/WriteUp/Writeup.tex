...
For our initial UNET architecture, a DCF of 0.65 is achieved after 20 epochs of training with batch sizes of 32. 

 \begin{figure}[H]
  \centerline{\includegraphics[width=0.5\textwidth]{Plots/AverageErrorKullEvery5000.png}}
  \caption{The accuracy of the segmentation prediction across epochs. An eventual coefficient of 0.67 is achieved after 20 epochs}
...
\section{Conclusions}
The results using a UNET architecture are promising. That said, the score that was achieved is inferior to the best score for the Kaggle competition which was 0.73226. So there is work to be done to even get our UNET architecture to the state of the art. 
